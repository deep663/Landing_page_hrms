const Card = ({ title, total, inService, imgSrc }) => (
    <div className="card p-6 text-center border-2 border-gray-200 rounded-lg bg-white shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out">
        <img
            alt={`${title} Logo`}
